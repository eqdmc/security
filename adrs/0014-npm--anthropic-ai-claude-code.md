# ADR-0014: `npm/@anthropic-ai/claude-code` — BLOCKED

- **Status:** Proposed
- **Date:** 2026-06-30
- **Approved by:** pending (`@eqdmc/security-review`)
- **Verdict:** BLOCKED (gates: 0/4, scored: 4/4)
...
| 4 | Quarantine >= 7 days | FAIL | Published 2026-06-29T20:08:58.871Z (0d ago) |
